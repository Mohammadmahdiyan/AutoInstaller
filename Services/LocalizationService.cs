...
public class LocalizationService
{
    private static readonly Dictionary<string, string> EnglishStrings = new()
    {
        ...
        ["UninstallCompleted"] = "The mod was uninstalled successfully.",
        ["UninstallModFailed"] = "The selected mod could not be uninstalled.",
        ...
        ["DetectedModStatus"] = "Detected mod: {0} ✓",
        ["AssetStepTitleVehicle"] = "If you wish to select the Vehicle model to be replaced...",
        ["AssetStepTitleWeapon"] = "If you wish to select the Weapon model to be replaced...",
        ["AssetStepTitleSkin"] = "If you wish to select the Skin model to be replaced...",
        ["AssetStepTitleGeneric"] = "If you wish to select the model to be replaced...",
        ["AssetTypeVehicle"] = "Vehicle",
        ["AssetTypeSkin"] = "Skin",
        ["AssetTypeWeapon"] = "Weapon",
        ["AssetTypePromptTitle"] = "Select asset type",
        ["AssetTypePrompt"] = "The model '{0}' was not found. Select its asset type.",
        ["AssetCategory"] = "Category",
        ["AssetColumns"] = "Columns",
        ["AssetAll"] = "All",
        ["AssetNoMatching"] = "No matching assets were found in this Mod.",
        ...
        ["ImageNotValid"] = "IMAGE NOT VALID",
        ["ImageUnavailable"] = "No image available",
        ["ImageUnavailableFriendly"] = "No image available",
        ["BaseModsFolderTitle"] = "Base Mods Folder",
        ["BaseModsFolderSubtitle"] = "Select the base mod folder for easy access",
        ["Previous"] = "Previous",
        ["Next"] = "Next",
        ["ShowMore"] = "Show More",
        ["ShowLess"] = "Show Less",
    ...
    private static readonly Dictionary<string, string> PersianStrings = new()
    {
        ...
        ["InstallMod"] = "نصب مود",
        ["Install"] = "نصب",
        ["UninstallMod"] = "حذف مود",
        ["UninstallCompleted"] = "مود با موفقیت حذف شد.",
        ["UninstallModFailed"] = "حذف مود انتخاب‌شده انجام نشد.",
        ...
        ["LoadingVehicles"] = "در حال بارگذاری وسیله‌های نقلیه...",
        ["LoadingSkins"] = "در حال بارگذاری اسکین‌ها...",
        ["LoadingWeapons"] = "در حال بارگذاری اسلحه‌ها...",
        ["LoadingAssets"] = "در حال لود ...",
        ["LoadingAssets"] = "در حال لود ...",
        ...
        ["DetectedModStatus"] = "مود تشخیص داده شد: {0} ✓",
        ["AssetStepTitleVehicle"] = "اگر می‌خواهید مدل وسیله نقلیه جایگزین‌شده را انتخاب کنید...",
        ["AssetStepTitleWeapon"] = "اگر می‌خواهید مدل اسلحه جایگزین‌شده را انتخاب کنید...",
        ["AssetStepTitleSkin"] = "اگر می‌خواهید مدل شخصیت جایگزین‌شده را انتخاب کنید...",
        ["AssetStepTitleGeneric"] = "اگر می‌خواهید مدل جایگزین‌شده را انتخاب کنید...",
        ["AssetTypeVehicle"] = "وسیله نقلیه",
        ["AssetTypeSkin"] = "شخصیت",
        ["AssetTypeWeapon"] = "اسلحه",
        ["AssetTypePromptTitle"] = "نوع مدل را انتخاب کنید",
        ["AssetTypePrompt"] = "مدل «{0}» در فهرست شناخته‌شده‌ها نیست. نوع آن را انتخاب کنید.",
        ["AssetCategory"] = "دسته‌بندی",
        ["AssetColumns"] = "ستون‌ها",
        ["AssetAll"] = "همه",
        ["AssetNoMatching"] = "هیچ مورد منطبقی برای این مود پیدا نشد.",
        ...
        ["ReadmeFallback"] = "README",
        ["ImageNotValid"] = "تصویر نامعتبر",
        ["ImageUnavailable"] = "تصویر موجود نیست",
        ["ImageUnavailableFriendly"] = "تصویر موجود نیست",
        ["BaseModsFolderTitle"] = "پوشه پایه مودها",
        ["BaseModsFolderSubtitle"] = "پوشه پایه مود را برای دسترسی سریع انتخاب کنید",
        ["Previous"] = "قبلی",
        ["Next"] = "بعدی",
